/**
 *	this program finds maximum matching for only bipartite graph
**/

/*
warning : do not start vertex numbering from 0 (zero) for input perpose, start vertex numbering from 1 (one)
for example :-
	
Number of vertices in set - 1 :: 3

Number of vertices in set - 2 :: 2


Enter list entry for vertices in set - 1


Number of adjacent vertices of u1 :: 2
...
Number of adjacent vertices of u2 :: 2
...
Number of adjacent vertices of u3 :: 1
...
Number of adjacent vertices of v1 :: 2
...
Number of adjacent vertices of v2 :: 3
